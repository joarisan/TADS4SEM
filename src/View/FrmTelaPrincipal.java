...
public class FrmTelaPrincipal extends javax.swing.JFrame {
    ...
    public FrmTelaPrincipal(String perfil) {
        initComponents();
        if (perfil.equals("Usuário Admin")) {
            jMenuItemUsuario.setVisible(true);
            jMnItmConsultarVendas.setVisible(true);
        } else {
            jMenuItemUsuario.setVisible(false);
            jMnItmConsultarVendas.setVisible(false);
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jDsktopPane.setPreferredSize(new java.awt.Dimension(700, 400));
        ...
        jMnUsuario.setMnemonic('c');
        jMnUsuario.setText("Cadastro");
        ...
        jMnUsuario.add(jMnItmFornecedor);
        ...
        jMnUsuario.add(jMenuItemUsuario);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jDsktopPane, javax.swing.GroupLayout.DEFAULT_SIZE, 795, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jDsktopPane, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE)
        );
    ...
    private void jMnItmRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnItmRegistrarActionPerformed
      FrmRegistrarVendas tela = new FrmRegistrarVendas();
        tela.setVisible(true);
        jDsktopPane.add(tela);
